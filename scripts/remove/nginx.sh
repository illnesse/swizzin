...
APT='nginx-extras nginx libnginx-mod-http-fancyindex ssl-cert php php-cli php-fpm php-dev php-xml php-curl php-xmlrpc php-json php-mcrypt php-geoip php-xml php-mbstring php7.3-opcache'
apt_remove $APT
